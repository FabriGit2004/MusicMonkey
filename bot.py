...
async def play(ctx, *, search_query):
    ...
    try:
        ...
        # Para reproducir necesitamos info completo del video
        ydl_opts_play = {
            'format': 'bestaudio/best',
            'quiet': True,
            'noplaylist': True,
        ...
        source = discord.FFmpegOpusAudio(
            url,
            executable="C:/Users/Fatec/Desktop/python/MusicMonkey/ffmpeg-7.1.1-essentials_build/ffmpeg-7.1.1-essentials_build/bin/ffmpeg.exe",
